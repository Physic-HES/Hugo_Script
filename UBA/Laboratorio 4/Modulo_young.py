...
E_cobre=np.zeros((2,))
E_acero=np.zeros((2,))
E_cobre[0]=32*(0.5*0.468**2-0.468**3/3)/(np.pi*(0.0051**4))/cob_coef[0][0]
E_cobre[1]=np.sqrt((32*(0.468**2)/(np.pi*(0.0051**4))/cob_coef[0][0]*0.001)**2+
                   (32*(0.5*0.468*2-0.468**2)/(np.pi*(0.0051**4))/cob_coef[0][0]*0.001)**2+
                   (32*(0.5*0.468**2-0.468**3/3)/(np.pi*(0.0051**5))/cob_coef[0][0]*4*0.00002)**2+
                   (32*(0.5*0.468**2-0.468**3/3)/(np.pi*(0.0051**4))/cob_coef[0][0]**2*np.sqrt(cob_coef[1]/len(cob_coef[0])))**2)
