...
% lib call
[errorCode, PositionerName, MinimumPosition, MaximumPosition, PositionStep, EnableState] = calllib('XPS_Q8_drivers', 'PositionerTimeFlasherGet', socketId, PositionerName, MinimumPosition, MaximumPosition, PositionStep, EnableState);
