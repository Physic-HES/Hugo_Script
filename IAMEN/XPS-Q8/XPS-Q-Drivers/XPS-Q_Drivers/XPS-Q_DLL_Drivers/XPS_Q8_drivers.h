...
DLL int __stdcall ControllerRTTimeGet (int SocketIndex, double * CurrentRTPeriod, double * CurrentRTUsage);  /* Get controller corrector period and calculation time */
DLL int __stdcall ControllerSlaveStatusGet (int SocketIndex, int * SlaveControllerStatus);  /* Read slave controller status */
DLL int __stdcall ControllerSlaveStatusStringGet (int SocketIndex, int SlaveControllerStatusCode, char * SlaveControllerStatusString);  /* Return the slave controller status string */
DLL int __stdcall ControllerSynchronizeCorrectorISR (int SocketIndex, char * ModeString);  /* Synchronize controller corrector ISR */
DLL int __stdcall ControllerStatusGet (int SocketIndex, int * ControllerStatus);  /* Get controller current status and reset the status */
DLL int __stdcall ControllerStatusRead (int SocketIndex, int * ControllerStatus);  /* Read controller current status */
DLL int __stdcall ControllerStatusStringGet (int SocketIndex, int ControllerStatusCode, char * ControllerStatusString);  /* Return the controller status string */
...
DLL int __stdcall GroupInitializeNoEncoderReset (int SocketIndex, char * GroupName);  /* Start the initialization with no encoder reset */
...
DLL int __stdcall GroupInterlockDisable (int SocketIndex, char * GroupName);  /* Set group interlock disable */
DLL int __stdcall GroupInterlockEnable (int SocketIndex, char * GroupName);  /* Set group interlock enable */
...
DLL int __stdcall GroupMotionStatusGet (int SocketIndex, char * GroupName, int NbElements, int Status[]);  /* Return group or positioner status */
DLL int __stdcall GroupMoveAbort (int SocketIndex, char * GroupName);  /* Abort a move */
DLL int __stdcall GroupMoveAbortFast (int SocketIndex, char * GroupName, int AccelerationMultiplier);  /* Abort quickly a move */
...
DLL int __stdcall PositionerCompensatedPCOAbort (int SocketIndex, char * PositionerName);  /* Abort CIE08 compensated PCO mode */
DLL int __stdcall PositionerCompensatedPCOCurrentStatusGet (int SocketIndex, char * PositionerName, int * Status);  /* Get current status of CIE08 compensated PCO mode */
DLL int __stdcall PositionerCompensatedPCOEnable (int SocketIndex, char * PositionerName);  /* Enable CIE08 compensated PCO mode execution */
DLL int __stdcall PositionerCompensatedPCOFromFile (int SocketIndex, char * PositionerName, char * DataFileName);  /* Load file to CIE08 compensated PCO data buffer */
DLL int __stdcall PositionerCompensatedPCOLoadToMemory (int SocketIndex, char * PositionerName, char * DataLines);  /* Load data lines to CIE08 compensated PCO data buffer */
DLL int __stdcall PositionerCompensatedPCOMemoryReset (int SocketIndex, char * PositionerName);  /* Reset CIE08 compensated PCO data buffer */
DLL int __stdcall PositionerCompensatedPCOPrepare (int SocketIndex, char * PositionerName, int ScanDirection, int NbElements, double StartPosition[]);  /* Prepare data for CIE08 compensated PCO mode */
DLL int __stdcall PositionerCompensatedPCOSet (int SocketIndex, char * PositionerName, double Start, double Stop, double Distance, double Width);  /* Set data to CIE08 compensated PCO data buffer */
DLL int __stdcall PositionerCompensationFrequencyNotchsGet (int SocketIndex, char * PositionerName, double * NotchFrequency1, double * NotchBandwidth1, double * NotchGain1, double * NotchFrequency2, double * NotchBandwidth2, double * NotchGain2, double * NotchFrequency3, double * NotchBandwidth3, double * NotchGain3);  /* Read frequency compensation notch filters parameters  */
DLL int __stdcall PositionerCompensationFrequencyNotchsSet (int SocketIndex, char * PositionerName, double NotchFrequency1, double NotchBandwidth1, double NotchGain1, double NotchFrequency2, double NotchBandwidth2, double NotchGain2, double NotchFrequency3, double NotchBandwidth3, double NotchGain3);  /* Update frequency compensation notch filters parameters  */
DLL int __stdcall PositionerCompensationLowPassTwoFilterGet (int SocketIndex, char * PositionerName, double * CutOffFrequency);  /* Read second order low-pass filter parameters  */
DLL int __stdcall PositionerCompensationLowPassTwoFilterSet (int SocketIndex, char * PositionerName, double CutOffFrequency);  /* Update second order low-pass filter parameters  */
DLL int __stdcall PositionerCompensationNotchModeFiltersGet (int SocketIndex, char * PositionerName, double * NotchModeFr1, double * NotchModeFa1, double * NotchModeZr1, double * NotchModeZa1, double * NotchModeFr2, double * NotchModeFa2, double * NotchModeZr2, double * NotchModeZa2);  /* Read notch mode filters parameters  */
DLL int __stdcall PositionerCompensationNotchModeFiltersSet (int SocketIndex, char * PositionerName, double NotchModeFr1, double NotchModeFa1, double NotchModeZr1, double NotchModeZa1, double NotchModeFr2, double NotchModeFa2, double NotchModeZr2, double NotchModeZa2);  /* Update notch mode filters parameters  */
DLL int __stdcall PositionerCompensationPhaseCorrectionFiltersGet (int SocketIndex, char * PositionerName, double * PhaseCorrectionFn1, double * PhaseCorrectionFd1, double * PhaseCorrectionGain1, double * PhaseCorrectionFn2, double * PhaseCorrectionFd2, double * PhaseCorrectionGain2);  /* Read phase correction filters parameters  */
DLL int __stdcall PositionerCompensationPhaseCorrectionFiltersSet (int SocketIndex, char * PositionerName, double PhaseCorrectionFn1, double PhaseCorrectionFd1, double PhaseCorrectionGain1, double PhaseCorrectionFn2, double PhaseCorrectionFd2, double PhaseCorrectionGain2);  /* Update phase correction filters parameters  */
DLL int __stdcall PositionerCompensationSpatialPeriodicNotchsGet (int SocketIndex, char * PositionerName, double * SpatialNotchStep1, double * SpatialNotchBandwidth1, double * SpatialNotchGain1, double * SpatialNotchStep2, double * SpatialNotchBandwidth2, double * SpatialNotchGain2, double * SpatialNotchStep3, double * SpatialNotchBandwidth3, double * SpatialNotchGain3);  /* Read spatial compensation notch filters parameters  */
DLL int __stdcall PositionerCompensationSpatialPeriodicNotchsSet (int SocketIndex, char * PositionerName, double SpatialNotchStep1, double SpatialNotchBandwidth1, double SpatialNotchGain1, double SpatialNotchStep2, double SpatialNotchBandwidth2, double SpatialNotchGain2, double SpatialNotchStep3, double SpatialNotchBandwidth3, double SpatialNotchGain3);  /* Update spatial compensation notch filters parameters  */
DLL int __stdcall PositionerCorrectorNotchFiltersSet (int SocketIndex, char * PositionerName, double NotchFrequency1, double NotchBandwidth1, double NotchGain1, double NotchFrequency2, double NotchBandwidth2, double NotchGain2);  /* Update filters parameters  */
DLL int __stdcall PositionerCorrectorNotchFiltersGet (int SocketIndex, char * PositionerName, double * NotchFrequency1, double * NotchBandwidth1, double * NotchGain1, double * NotchFrequency2, double * NotchBandwidth2, double * NotchGain2);  /* Read filters parameters  */
DLL int __stdcall PositionerCorrectorPIDBaseSet (int SocketIndex, char * PositionerName, double MovingMass, double StaticMass, double Viscosity, double Stiffness);  /* Update PIDBase parameters  */
DLL int __stdcall PositionerCorrectorPIDBaseGet (int SocketIndex, char * PositionerName, double * MovingMass, double * StaticMass, double * Viscosity, double * Stiffness);  /* Read PIDBase parameters  */
...
DLL int __stdcall PositionerCorrectorSR1AccelerationSet (int SocketIndex, char * PositionerName, bool ClosedLoopStatus, double KP, double KI, double KV, double ObserverFrequency, double CompensationGainVelocity, double CompensationGainAcceleration, double CompensationGainJerk);  /* Update corrector parameters */
DLL int __stdcall PositionerCorrectorSR1AccelerationGet (int SocketIndex, char * PositionerName, bool * ClosedLoopStatus, double * KP, double * KI, double * KV, double * ObserverFrequency, double * CompensationGainVelocity, double * CompensationGainAcceleration, double * CompensationGainJerk);  /* Read corrector parameters */
DLL int __stdcall PositionerCorrectorSR1ObserverAccelerationSet (int SocketIndex, char * PositionerName, double ParameterA, double ParameterB, double ParameterC);  /* Update SR1 corrector observer parameters */
DLL int __stdcall PositionerCorrectorSR1ObserverAccelerationGet (int SocketIndex, char * PositionerName, double * ParameterA, double * ParameterB, double * ParameterC);  /* Read SR1 corrector observer parameters */
DLL int __stdcall PositionerCorrectorSR1OffsetAccelerationSet (int SocketIndex, char * PositionerName, double AccelerationOffset);  /* Update SR1 corrector output acceleration offset */
DLL int __stdcall PositionerCorrectorSR1OffsetAccelerationGet (int SocketIndex, char * PositionerName, double * AccelerationOffset);  /* Read SR1 corrector output acceleration offset */
...
DLL int __stdcall PositionerExcitationSignalGet (int SocketIndex, char * PositionerName, int * Mode, double * Frequency, double * Amplitude, double * Time);  /* Get excitation signal mode */
DLL int __stdcall PositionerExcitationSignalSet (int SocketIndex, char * PositionerName, int Mode, double Frequency, double Amplitude, double Time);  /* Set excitation signal mode */
...
DLL int __stdcall PositionerHardInterpolatorPositionGet (int SocketIndex, char * PositionerName, double * Position);  /* Read external latch position */
...
DLL int __stdcall PositionerPositionCompareScanAccelerationLimitGet (int SocketIndex, char * PositionerName, double * ScanAccelerationLimit);  /* Get position compare scan acceleration limit */
DLL int __stdcall PositionerPositionCompareScanAccelerationLimitSet (int SocketIndex, char * PositionerName, double ScanAccelerationLimit);  /* Set position compare scan acceleration limit */
DLL int __stdcall PositionerPreCorrectorExcitationSignalGet (int SocketIndex, char * PositionerName, double * Frequency, double * Amplitude, double * Time);  /* Get pre-corrector excitation signal mode */
DLL int __stdcall PositionerPreCorrectorExcitationSignalSet (int SocketIndex, char * PositionerName, double Frequency, double Amplitude, double Time);  /* Set pre-corrector excitation signal mode */
...
DLL int __stdcall PositionerWarningFollowingErrorSet (int SocketIndex, char * PositionerName, double WarningFollowingError);  /* Set positioner warning following error limit */
DLL int __stdcall PositionerWarningFollowingErrorGet (int SocketIndex, char * PositionerName, double * WarningFollowingError);  /* Get positioner warning following error limit */
...
DLL int __stdcall MultipleAxesPVTLoadToMemory (int SocketIndex, char * GroupName, char * TrajectoryPart);  /* Multiple Axes Load PVT trajectory through function */
DLL int __stdcall MultipleAxesPVTResetInMemory (int SocketIndex, char * GroupName);  /* Multiple Axes PVT trajectory reset in memory */
...
DLL int __stdcall SingleAxisThetaClampDisable (int SocketIndex, char * GroupName);  /* Set clamping disable on selected group */
DLL int __stdcall SingleAxisThetaClampEnable (int SocketIndex, char * GroupName);  /* Set clamping enable on selected group */
DLL int __stdcall SingleAxisThetaSlaveModeEnable (int SocketIndex, char * GroupName);  /* Enable the slave mode */
DLL int __stdcall SingleAxisThetaSlaveModeDisable (int SocketIndex, char * GroupName);  /* Disable the slave mode */
DLL int __stdcall SingleAxisThetaSlaveParametersSet (int SocketIndex, char * GroupName, char * PositionerName, double Ratio);  /* Set slave parameters */
DLL int __stdcall SingleAxisThetaSlaveParametersGet (int SocketIndex, char * GroupName, char * PositionerName, double * Ratio);  /* Get slave parameters */
...
DLL int __stdcall XYPVTVerification (int SocketIndex, char * GroupName, char * TrajectoryFileName);  /* XY PVT trajectory verification */
DLL int __stdcall XYPVTVerificationResultGet (int SocketIndex, char * PositionerName, char * FileName, double * MinimumPosition, double * MaximumPosition, double * MaximumVelocity, double * MaximumAcceleration);  /* XY PVT trajectory verification result get */
DLL int __stdcall XYPVTExecution (int SocketIndex, char * GroupName, char * TrajectoryFileName, int ExecutionNumber);  /* XY PVT trajectory execution */
DLL int __stdcall XYPVTParametersGet (int SocketIndex, char * GroupName, char * FileName, int * CurrentElementNumber);  /* XY PVT trajectory get parameters */
DLL int __stdcall XYPVTPulseOutputSet (int SocketIndex, char * GroupName, int StartElement, int EndElement, double TimeInterval);  /* Configure pulse output on trajectory */
DLL int __stdcall XYPVTPulseOutputGet (int SocketIndex, char * GroupName, int * StartElement, int * EndElement, double * TimeInterval);  /* Get pulse output on trajectory configuration */
DLL int __stdcall XYPVTLoadToMemory (int SocketIndex, char * GroupName, char * TrajectoryPart);  /* XY Load PVT trajectory through function */
DLL int __stdcall XYPVTResetInMemory (int SocketIndex, char * GroupName);  /* XY PVT trajectory reset in memory */
...
DLL int __stdcall XYZGroupPositionPCORawEncoderGet (int SocketIndex, char * GroupName, double PositionX, double PositionY, double PositionZ, double * PCORawPositionX, double * PCORawPositionY, double * PCORawPositionZ);  /* Return PCO raw encoder positions */
...
DLL int __stdcall TZPVTVerification (int SocketIndex, char * GroupName, char * TrajectoryFileName);  /* TZ PVT trajectory verification */
DLL int __stdcall TZPVTVerificationResultGet (int SocketIndex, char * PositionerName, char * FileName, double * MinimumPosition, double * MaximumPosition, double * MaximumVelocity, double * MaximumAcceleration);  /* TZ PVT trajectory verification result get */
DLL int __stdcall TZPVTExecution (int SocketIndex, char * GroupName, char * TrajectoryFileName, int ExecutionNumber);  /* TZ PVT trajectory execution */
DLL int __stdcall TZPVTParametersGet (int SocketIndex, char * GroupName, char * FileName, int * CurrentElementNumber);  /* TZ PVT trajectory get parameters */
DLL int __stdcall TZPVTPulseOutputSet (int SocketIndex, char * GroupName, int StartElement, int EndElement, double TimeInterval);  /* Configure pulse output on trajectory */
DLL int __stdcall TZPVTPulseOutputGet (int SocketIndex, char * GroupName, int * StartElement, int * EndElement, double * TimeInterval);  /* Get pulse output on trajectory configuration */
DLL int __stdcall TZPVTLoadToMemory (int SocketIndex, char * GroupName, char * TrajectoryPart);  /* TZ Load PVT trajectory through function */
DLL int __stdcall TZPVTResetInMemory (int SocketIndex, char * GroupName);  /* TZ PVT trajectory reset in memory */
DLL int __stdcall TZFocusModeEnable (int SocketIndex, char * GroupName);  /* Enable the focus mode */
DLL int __stdcall TZFocusModeDisable (int SocketIndex, char * GroupName);  /* Disable the focus mode */
DLL int __stdcall TZTrackingUserMaximumZZZTargetDifferenceGet (int SocketIndex, char * GroupName, double * UserMaximumZZZTargetDifference);  /* Get user maximum ZZZ target difference for tracking control */
DLL int __stdcall TZTrackingUserMaximumZZZTargetDifferenceSet (int SocketIndex, char * GroupName, double UserMaximumZZZTargetDifference);  /* Set user maximum ZZZ target difference for tracking control */
DLL int __stdcall FocusProcessSocketReserve (int SocketIndex);  /* Set user maximum ZZZ target difference for tracking control */
DLL int __stdcall FocusProcessSocketFree (int SocketIndex);  /* Set user maximum ZZZ target difference for tracking control */
DLL int __stdcall PositionerMotorOutputOffsetGet (int SocketIndex, char * PositionerName, double * PrimaryDAC1, double * PrimaryDAC2, double * SecondaryDAC1, double * SecondaryDAC2);  /* Get soft (user defined) motor output DAC offsets */
DLL int __stdcall PositionerMotorOutputOffsetSet (int SocketIndex, char * PositionerName, double PrimaryDAC1, double PrimaryDAC2, double SecondaryDAC1, double SecondaryDAC2);  /* Set soft (user defined) motor output DAC offsets */
DLL int __stdcall SingleAxisThetaPositionRawGet (int SocketIndex, char * GroupName, double * RawEncoderPosition1, double * RawEncoderPosition2, double * RawEncoderPosition3);  /* Get raw encoder positions for single axis theta encoder */
DLL int __stdcall EEPROMCIESet (int SocketIndex, int CardNumber, char * ReferenceString);  /* Get raw encoder positions for single axis theta encoder */
DLL int __stdcall EEPROMDACOffsetCIESet (int SocketIndex, int PlugNumber, double DAC1Offset, double DAC2Offset);  /* Get raw encoder positions for single axis theta encoder */
DLL int __stdcall EEPROMDriverSet (int SocketIndex, int PlugNumber, char * ReferenceString);  /* Get raw encoder positions for single axis theta encoder */
DLL int __stdcall EEPROMINTSet (int SocketIndex, int CardNumber, char * ReferenceString);  /* Get raw encoder positions for single axis theta encoder */
...
DLL int __stdcall CPUTemperatureAndFanSpeedGet (int SocketIndex, double * CPUTemperature, double * CPUFanSpeed);  /* Get raw encoder positions for single axis theta encoder */
...
DLL int __stdcall OptionalModuleExecute (int SocketIndex, char * ModuleFileName);  /* Execute an optional module */
